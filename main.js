...
function scrollHeader() {
  ...
  //   emailjs.send("service_mxkickp","template_jtypr7y", emaildatas);
...
// function sendemail() {
//     let name = document.querySelector("#from_name input").value;
//     let email = document.querySelector("#email_id input").value;
...
function sendemail() {
  let nameInput = document.querySelector("#from_name input");
  let emailInput = document.querySelector("#email_id input");
